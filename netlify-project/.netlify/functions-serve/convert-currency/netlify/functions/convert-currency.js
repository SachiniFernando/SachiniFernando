...
// netlify/functions/convert-currency.ts
var convert_currency_exports = {};
__export(convert_currency_exports, {
  handler: () => handler
});
module.exports = __toCommonJS(convert_currency_exports);
